...
def train_model(X_train, y_train, X_val, y_val, ranker, query, out_dir, learning_rate=0.12, boost_method="dart"):
    ...
    if ranker == 'kmeans':
        ...
        model = lightgbm.LGBMRanker(objective="lambdarank", metric="ndcg", n_estimators=5000, learning_rate=learning_rate,
                                    max_position=5, label_gain=[0, 1, 2], random_state=42, seed=42, boosting=boost_method)
